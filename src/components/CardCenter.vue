...
<template>
  <div class="card lg:card-side bg-base-100 flex mt-6 mx-auto w-[90%] flex-row-reverse">
    <figure class="w-1/2 xl:h-[360px] xl:mt-[60px] 
    md:mt-[50px] md:h-[360px]
    min-[375px]:h-[250px]">
      <img src="https://picsum.photos/id/2/300/200" alt="Album" class="h-full w-full" />
    </figure>
    <div class="card-body border-solid shadow-xl border-red-200 mx-auto w-1/2 flex flex-col xl:h-[450px] lg:h-[450px] md:h-[450px] lg:space-y-[70px]
      xl:space-y-[60px] xl:mt-[20px] min-[375px]:space-y-[0px] justify-center
      md:space-y-20 min-[425px]:h-[250px] min-[375px]:h-[250px]">
      <h2 class="card-title text-center bg-Gold h-2 mx-auto w-1/2 mt-4 mb-4 sm:text-sm"></h2>
  ...
  <div class="card lg:card-side bg-base-100 flex mt-8 mx-auto w-[90%] flex-row">
    <figure class="w-1/2 xl:h-[360px] xl:mt-[60px] 
    md:mt-[50px] md:h-[360px]
    min-[375px]:h-[250px]">
      <img src="https://picsum.photos/id/2/300/200" alt="Album" class="h-full w-full" />
    ...
    <div class="card-body border-solid shadow-xl border-red-200 mx-auto w-1/2 flex flex-col xl:h-[450px] lg:h-[450px] md:h-[450px] lg:space-y-[70px]
      xl:space-y-[60px] xl:mt-[20px] min-[375px]:space-y-[0px] justify-center
      md:space-y-20 min-[425px]:h-[250px] min-[375px]:h-[250px]">
      <h2 class="card-title text-center bg-Primary-Blue h-2 mx-auto w-1/2 mt-4 mb-4 sm:text-sm"></h2>
  ...
  <div class="card lg:card-side bg-base-100 flex mt-8 mx-auto w-[90%] flex-row-reverse">
    <figure class="w-1/2 xl:h-[360px] xl:mt-[60px] 
    md:mt-[50px] md:h-[360px]
    min-[375px]:h-[250px]">
      <img src="https://picsum.photos/id/2/300/200" alt="Album" class="h-full w-full" />
    ...
    <div class="card-body border-solid shadow-xl border-red-200 mx-auto w-1/2 flex flex-col xl:h-[450px] lg:h-[450px] md:h-[450px] lg:space-y-[70px]
      xl:space-y-[60px] xl:mt-[20px] min-[375px]:space-y-[1px] justify-center
      md:space-y-20 min-[425px]:h-[250px] min-[375px]:h-[250px]">
      <h2 class="card-title text-center bg-Primary-Red h-2 mx-auto w-1/2 mt-4 mb-4 sm:text-sm"></h2>
